...
export class DetailService {
  ...
  private baseUrl = 'http://localhost:8080/api/detail';
  //private urlImg = 'http://localhost:8080/api/productimg';
  private urlImgList = 'http://localhost:8080/api/detailimglist';
  private urlImg2 = 'http://localhost:8080/api/detailimgA';
