...
public interface CategoryRepository extends JpaRepository<Category, Long> {
    @Query(value = "select *from (category as c inner join category_categorytype as cc on c.category_id = cc.category_id) inner join categorytype as ctype on cc.categorytype_id = ctype.categorytype_id\n" +
